...
## 假本接著
  ...
  <img src="https://user-images.githubusercontent.com/79491888/178648731-ce41a65f-8014-4eb7-ac7e-6c5e3eaff8b9.png" width="600px">  
...
## 防銲工程
  因保膠沖頭開口精度不夠，故將保膠無法貼合裸露之線路以油墨覆蓋，保護線路避免氧化，油墨有耐高溫優勢利於後段實裝加工  
  - MBC目的:　將製品表面氧化的髒污、油污去除，再利用微蝕刻方式將銅面咬蝕成粗糙化狀，增加油墨附著力。
  - 尺寸量測目的:因銅材會有脹縮的問題，需先取製品做2.5次元量測後挑選適合的露光底片。
  - 油墨印刷目的:利用網目將油墨印刷於保膠開口處的線路導體上
  - 靜置乾燥目的:讓印刷在製品上的油墨表面乾燥，避免油墨轉印
  - 露光目的:利用UV照射，油墨因感光反應所需的圖形曝光，使感光油墨可行固化作用
  - 顯像目的:使用顯影液將未曝光之油墨去除，顯露防焊開口。
  - 熟化目的:以真空氮氣烘箱高溫烘烤製品，使其乾燥，且使油墨完全固化 。
...
### 電鍍金
  #### 預鍍金
    說明: 標準電位:a.Ni=-0.25,b.Cu=+0.34,c.Au=+1.68(氫之標準電位為0),各成分之電位顯示,鎳為負電位,易失去電子 ,易被氧化  
          ,易腐蝕;金為正電位,不易氧化,不易溶解,故鍍銅金前需鍍上鎳,讓金離子可以更容易沉積在鎳層  
    目的:由於金與鎳電位差較大,在鍍金前預鍍金,利用較高的電流使得金可以直接鍍上鎳層 ,預鍍金濃度較低,鍍層較薄  
         主要為打底用,每三個月會更換一次  
    製造條件確認:藥液濃度,溫度  
...
#### 會先貼barcode(條碼)方便後續NG標記及資料上傳
  ...
  <img src = "https://user-images.githubusercontent.com/79491888/179458637-2e79113d-f792-44df-a781-54b7a312f1aa.png" width="550px">  

### 補材貼合
  目的:  
  1.補強板,補膠貼合於製品背面,以增加材料之應力,依客戶用途作區域性的補強;貼合後經高溫高壓壓著,之後  
    送入烘箱進行熟化  
  2.黏著劑膠片(客戶端需求)  
  ![image](https://user-images.githubusercontent.com/79491888/178415838-636351b5-f186-4f35-871e-8ed36a168f82.png)  
  
  製造條件:
  ```
  1假貼合:溫度,壓力,壓合秒數
  2.熱壓著:溫度,壓力,壓合時間,熱盤結構
  3.烘箱:溫度,時間
  ```
  
  品質確認:
  ```
  偏移,異物,貼合不密合,溢出,脫落,附著物,折打痕,發泡,皺折
  (QJ01-001~QJ02-005)
  ```
...
### 穴拔
  ...
  ```
  1.補材設定孔(貼合補材用)
  2.防止龜裂拔(因端子部貼合補強膠片後,造成與周圍環境有高低差異,在端子部若無穴拔對後續外形加工會有龜裂的情形發生)
  3.斷線拔(針對FPC把各PCS之端子部或尾端進行穴拔,以獨立單PCS,後續電測才可確認哪一PCS有導通不良的情形),TO偏移測試孔
  4.穴拔二設定孔(針對LAYOUT較複雜的產品無法一次完成,穴拔一完成後再增加穴拔程序)
  ```
  ![image](https://user-images.githubusercontent.com/79491888/178414993-6ccc2c88-9857-4e2c-a583-9c5e66c902dc.png)  
  ...
  品質確認:
  ```
  1.偏移(QF孔確認),2.毛邊,3.段差,4.裂痕,5.穴未脫落,6.保膠補材剝離
  7.折打傷裂痕,8.油污、附著物(QJ03-001~006,QJ04-001)
  ```
  
### 電測
  目的:利用探針測試線路是否OPEN or SHORT(電阻值100Ω以上:OPEN ; 50V,100KΩ以下:SHORT)  
  測試項目:  
  ```
  1.OPEN(斷路)：測試製品導体線路有無斷路。
  2.SHORT(短路)：測試製品相鄰導体線路間有無短路。 
  3.TO(打拔偏移)：測試製品打拔後是否偏移，超出製品規範。
  4.BY(補材漏貼)：測試製品是否未貼付補材，防止不良流出。
  5.FEED MISS(飛越測)：防止製品測試時，作業手順錯誤漏電測。
  ```
  製造條件:電測治具編號  
  品質確認:探針打痕,打折痕(QJ05-001)  
  
### 外形
  將電測後之FPC貼合低黏著膠片, 使用刀刃模具(QAA-M,QD-M)進行外形打拔,打拔後撕離即SHEET > PCS  
  ![image](https://user-images.githubusercontent.com/79491888/178416704-0eba296c-d5fb-407a-bca2-d44a4bd6bebe.png)  
